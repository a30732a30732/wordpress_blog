 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'RDp)9X]:Jg+|92lRAQ780!M(+`_$rrUA&sY_[r{3U$b!. Fu=+xA>e<%&9}7&aD-');
define('SECURE_AUTH_KEY',  '<~tpj5=}#7hn]_tvT;o>qSnL#cQHmM YqgD&]uNY@CzNqx!cLQq1p]x7.%-Bxxgj');
define('LOGGED_IN_KEY',    'KbY pBm #~J[7MVWy0K=$`o/@PJX0V,*p5gXcAPO{9?VKuD<B1Z%lk?dz>L_E|]L');
define('NONCE_KEY',        'Hl1KI2$dKn]+ S:/.<[N`5,F,bhpw65^I3!x}2{eKq(+g%gP7QHpmO}90;x-CB}w');
define('AUTH_SALT',        '%v dX`T/_QxD!o!%3D yePfb6p]RJlrQg$;Xs[$f0:(2&o*?Rn7Qn%?>iMk+gmtm');
define('SECURE_AUTH_SALT', 'nfDV,5y}n.j%5dq=[M^%Ykz<6_yOK^KmYn&iF8F9Kr[_+Xk e3)wUGe3,5WIIE]Z');
define('LOGGED_IN_SALT',   '*Dl5:*h=:^td7[{beq6^IdEf(]d~Aaguvh=q.3c)!4vR1qJ3N5/frwg%9Nb[Q:];');
define('NONCE_SALT',       'ZG;@>S=iQAb&_YY{v?nva-Nj ?_g2..sU.+(!eiuJEvFL[b_U_^Xht_I,o9G~Cv/');
